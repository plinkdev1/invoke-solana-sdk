content = """[gd_scene load_steps=10 format=3]
...
[ext_resource type="Shader" path="res://shaders/glass_card.gdshader" id="3"]
...
[sub_resource type="StyleBoxFlat" id="StyleBoxFlat_phantom"]
bg_color = Color(0.553, 0.420, 0.882, 1.0)
...
[sub_resource type="StyleBoxFlat" id="StyleBoxFlat_backpack"]
bg_color = Color(0.05, 0.05, 0.05, 1.0)
corner_radius_top_left = 14
corner_radius_top_right = 14
corner_radius_bottom_right = 14
corner_radius_bottom_left = 14
...
[sub_resource type="StyleBoxFlat" id="StyleBoxFlat_solflare"]
bg_color = Color(0.996, 0.859, 0.122, 1.0)
corner_radius_top_left = 14
corner_radius_top_right = 14
corner_radius_bottom_right = 14
corner_radius_bottom_left = 14
...
[node name="Icon" type="TextureRect" parent="Scroll/VBox/CardPhantom/BtnPhantom/Row/IconBox"]
layout_mode = 2
custom_minimum_size = Vector2(60, 60)
...
[node name="Icon" type="TextureRect" parent="Scroll/VBox/CardBackpack/BtnBackpack/Row/IconBox"]
layout_mode = 2
custom_minimum_size = Vector2(60, 60)
...
[node name="Icon" type="TextureRect" parent="Scroll/VBox/CardSolflare/BtnSolflare/Row/IconBox"]
layout_mode = 2
custom_minimum_size = Vector2(60, 60)
...
with open(r'C:\PROJECTS\Invoke_Solana_App\example\invokequest\scenes\screens\WalletPicker.tscn', 'w', encoding='utf-8', newline='\n') as f:
    f.write(content)
print('WalletPicker.tscn written.')
